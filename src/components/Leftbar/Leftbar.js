...
import './leftbar.css'
import{RssFeed,Chat,Videocam,Groups,Bookmark,Help,Work,InsertInvitation,School }from '@mui/icons-material';
        ...
        <div className="leftbar">
           <div className="leftbarWrapper">
               <ul className="leftbarlList">
                   ...
                   <li className="leftbarListItem">
                       <InsertInvitation className="leftbarIcon"/>
